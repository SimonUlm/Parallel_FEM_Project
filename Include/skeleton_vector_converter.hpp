...
namespace Skeleton {
     ...
     * VectorConverter
     *
     * The VectorConverter class is used for converting accumulated vectors into
     * distributed vectors and vice versa
     *
     */
    ...
    private:
        ...
        long n_global_crosspoints_; // number of global cross points
